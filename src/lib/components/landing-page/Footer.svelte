...
<footer class="body-font text-info">
  <div
  ...
  >
    ...
    >
      ...
      <span class="ml-3 text-xl">{website.siteTitle}</span>
    </a>
    <p
    ...
    >
      <a class="text-info" href={website.facebookPage}>
        <svg
          fill="currentColor"
          stroke-linecap="round"
          stroke-linejoin="round"
      ...
      <!-- <a class="ml-3 text-info" href={website.twitterPage}>
        <svg
          fill="currentColor"
          stroke-linecap="round"
          stroke-linejoin="round"
      ...
      <a class="ml-3 text-info" href={website.instagramPage}>
        <svg
          fill="none"
          stroke="currentColor"
          stroke-linecap="round"
      ...
      <a class="ml-3 text-info" href={website.linkedinProfile}>
        <svg
          fill="currentColor"
          stroke="currentColor"
          stroke-linecap="round"
